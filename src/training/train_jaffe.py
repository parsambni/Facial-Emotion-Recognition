...
from dataset import create_jaffe_dataloaders
from model import JAFFE_CNN
...
# Optimizer - Adam with good learning rate
...
# Training parameters
num_epochs = 250  # Enough epochs for convergence
best_val_acc = 0.0
patience = 60  # High patience for small dataset
patience_counter = 0
